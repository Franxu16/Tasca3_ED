...
public class PasswordVerify {
    public static PassWord_Result salida(String pssword){
        ...
        if(pssword.length() < 8){
            isValid = false;
            msgError.append("La contrasenya ha de tenir almenys 8 caracters").append("\n");
        }
        ...
        if(contadorDigitos < 2){
            isValid = false;
            msgError.append("La contrasenya ha de contenir almenys 2 numeros").append("\n");
        }
